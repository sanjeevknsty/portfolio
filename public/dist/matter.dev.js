...
window.myFunction = function () {
  var canvas = document.querySelector("#wrapper-canvas"); // console.log(canvas)
  ...
  function runMatter() {
    ...
    for (var i = 0; i < 60; i += 1) {
      ...
      var s = Common.random() > 0.6 ? Common.random(10, 80) : Common.random(4, 60);
      var poligonNumber = Common.random(3, 6);
  ...
  var m = runMatter();
  setWindowSize(); // window.resize(debounce(setWindowSize, 250));
};